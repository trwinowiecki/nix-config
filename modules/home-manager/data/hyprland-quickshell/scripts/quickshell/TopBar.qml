                    ...
                    Row {
                        ...
                        Rectangle {
                            ...
                            Text {
                                ...
                                text: themeTogglePill.themeMode === "light" ? "󰖙" : "󰖔"
                            ...
                            MouseArea {
                                ...
                                anchors.fill: parent
                                hoverEnabled: true
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/theme_toggle.sh"])
                            }

                            Process {
                                id: themeModeReader
                                command: ["bash", "-c", "cat ~/.config/hypr/theme_mode 2>/dev/null || echo dark"]
                                stdout: StdioCollector {
                                    onStreamFinished: {
                                        let mode = this.text.trim();
                                        if (mode === "light" || mode === "dark") {
                                            themeTogglePill.themeMode = mode;
                                        }
                                    }
                                }
                            }
                            ...
                            Timer {
                                ...
                                onTriggered: themeModeReader.running = true
                            }
                        }
