            ...
            Item {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        anchors.fill: parent
                        hoverEnabled: true
                        onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh toggle calendar"])
                    }
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            anchors.fill: parent
                            hoverEnabled: true
                            onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/rofi_show.sh drun"])
                        }
                    }
                            ...
                            Repeater {
                                ...
                                delegate: Rectangle {
                                    ...
                                    MouseArea {
                                        ...
                                        hoverEnabled: true
                                        anchors.fill: parent
                                        onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh " + wsName])
                                    }
                                }
                            }
                        }
                        ...
                        Item {
                            ...
                            Row {
                                ...
                                MouseArea {
                                    ...
                                    hoverEnabled: true
                                    onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh toggle music"])
                    ...
                    Rectangle {
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: wifiMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh toggle network wifi"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: btMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh toggle network bt"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: volMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh toggle volume"]) }
                            }
                            ...
                            Rectangle {
                                ...
                                MouseArea { id: batMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/hypr/scripts/quickshell/qs_manager.sh toggle battery"]) }
                            }
                        }
                    }
                }
