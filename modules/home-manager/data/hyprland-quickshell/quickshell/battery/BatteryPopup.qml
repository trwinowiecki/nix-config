        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Repeater {
                        model: ListModel {
                            ListElement { cmd: "bash ~/.config/hypr/scripts/quickshell/lock.sh"; icon: ""; baseColor: "mauve"; weight: 1.0 }
                            ListElement { cmd: "bash ~/.config/hypr/scripts/quickshell/lock.sh & systemctl suspend"; icon: "ᶻ 𝗓 𐰁"; baseColor: "blue"; weight: 1.0 }
